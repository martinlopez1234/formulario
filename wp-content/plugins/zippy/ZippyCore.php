...
class ZippyCore
{
    ...
    public function adminInit()
    {
        ...
        if (isset($_REQUEST['__action']) && $_REQUEST['__action'] === 'zippy-unzip') {
            ...
            if (!current_user_can('edit_posts')) {
                $this->adminNotice((__('You do not have sufficient permissions to access this page.')), 'error');
                return;
            }
    ...
    {
        if (apply_filters('zippy_show_in_admin_bar', true) && current_user_can('edit_posts')) {
    ...
    public function addMenu()
    {
        ...
        echo '<div class="wrap">';
        echo '<h1>' . __('Zippy (unzip)', 'zippy') . '</h1>';
