...
global $wp_session;
			...
			elseif ( 'payment_cancel' == $_GET['action'] )
                $message = __("You have canelled your registration.","pie-register");
			elseif ( 'payment_success' == $_GET['action'] )
                $success = __("Thank you for your registration. You will receieve your login credentials soon.","pie-register");		
