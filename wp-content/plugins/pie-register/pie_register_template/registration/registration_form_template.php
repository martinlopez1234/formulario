...
class Registration_form_template extends Registration_form
{
	...
	function addTextField(){
		...
		$data .= $this->addLabel();
		$data .= '<input '.$this->read_only.' id="'.$this->get_pr_widget_prefix().$this->id.'" name="'.$this->name.'" data-field_id="'.$this->get_pr_widget_prefix().'piereg_field_'.$this->no.'" class="'.$this->addClass().' '.$cl_class.'"'.$cl_data.'  '.$this->addValidation().'  placeholder="'.$this->field['placeholder'].'" type="text" value="'.$this->getDefaultValue().'" />';
		$data .= $this->addDesc();
		$data .= '</div>';
		return $data;
	}
	...
	function addPassword($fromwidget,$field_status = "")
	{
		...
		if( isset($this->field['password_generator']) && $this->field['password_generator'] != "" ){
			...
			//$data .= '<div class="edit_confirm_pass" style="display:none;">';
	...
	function addEmail($fromwidget)
	{
		...
		$data .='<input '.$_readonly.' id="'.$this->id.'" name="e_mail" data-field_id="'.$this->get_pr_widget_prefix().'piereg_field_'.$this->no.'" class="'.$this->addClass().' '.$cl_class.'"'.$cl_data.'  '.$this->addValidation().' placeholder="'.$this->field['placeholder'].'" type="text" value="'.$_email_invite.'" />';
	...
	function addTextArea()
	{
		...
		$data .= '<textarea '.$this->read_only.' id="'.$this->id.'" data-field_id="'.$this->get_pr_widget_prefix().'piereg_field_'.$this->no.'" name="'.$this->name.'" rows="'.$this->field['rows'].'" cols="'.$this->field['cols'].'" class="'.$this->addClass().' '.$cl_class.'" '.$this->addValidation().' placeholder="'.$this->field['placeholder'].'"'.$cl_data.'>';
	...
	function addName()
	{
		...
		$data .= '<input '.$this->read_only.' value="'.$this->getDefaultValue('first_name').'" placeholder="'.$placeholder.'" data-field_id="'.$this->get_pr_widget_prefix().'piereg_field_'.$this->no.'" id="'.$this->id.'_firstname" name="first_name" class="'.$this->addClass().' input_fields piereg_name_input_field '.$cl_class.'"'.$cl_data.' '.$this->addValidation().'  type="text"  />';				
	...
	function addNumberField()
	{
		...
		$data .= '<div class="fieldset">';
		$data .= $this->addLabel();
		$data .= '<input '.$this->read_only.'  id="'.$this->id.'" name="'.$this->name.'" data-field_id="'.$this->get_pr_widget_prefix().'piereg_field_'.$this->no.'" class="'.$this->addClass().' '.$cl_class.'"'.$cl_data.'  '.$this->addValidation().'  placeholder="'.$this->field['placeholder'].'" type="number" value="'.$this->getDefaultValue().'"' ;
	...
	function addPhone()
	{
		...
		$data  = '<div class="fieldset">';
		$data .= $this->addLabel();
		$data .= '<input '.$this->read_only.' id="'.$this->id.'" class="'.$this->addClass().' '.$cl_class.'"'.$cl_data.' data-field_id="'.$this->get_pr_widget_prefix().'piereg_field_'.$this->no.'"  '.$this->addValidation().' name="'.$this->name.'" type="text" value="'.$this->getDefaultValue().'" />';
		$data .= $this->addDesc();
		$data .= '</div>';
		return $data;
	}
	...
	function addInvitationField(){
		...
		$data .= $this->addLabel();
		$data .= '<input id="'.$this->id.'" name="invitation" class="'.$this->addClass().' '.$cl_class.'"'.$cl_data.' data-field_id="'.$this->get_pr_widget_prefix().'piereg_field_'.$this->no.'" placeholder="'.$this->field['placeholder'].'" type="'.$type.'" value="'.$invite_code.'" />';
		$data .= $this->addDesc();
		$data .= '</div>';
		return $data;
	}
