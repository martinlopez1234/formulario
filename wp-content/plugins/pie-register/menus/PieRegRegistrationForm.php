              ...
              <tr>
                ...
                <td class="column-title"><strong><?php echo $option['Title']; ?></strong>
                  <div class="piereg-actions">
                    ...
                    <span class="edit"><a class="underlinenone" href="<?php echo get_permalink($piereg['alternate_register']); ?>/?pr_preview=1&form_id=<?php echo $option['Id']; ?>&prFormId=<?php echo $option['Id']; ?>&form_name=<?php echo str_replace(" ","_",$option['Title']); ?>" target="_blank" title="Preview this form">Preview</a>
                    <?php
                			// task duplicate form
                    ...
                    ?>
                      | </span>
                      <span class="edit"><a class="underlinenone" href="admin.php?page=pie-register&form_id=<?php echo $option['Id']; ?>&form_action=<?php _e('duplication'); ?>" title="Duplicate this form">Duplicate</a>
                    <?php
                      }
                    ?>
                    </span>
