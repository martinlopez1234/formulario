    ...
    <div class="cols-3">          
      <select required id="pie_email_invitecode" name="pie_email_invitecode" >
        ...
        foreach($inviteCodes as $key => $val){
          ...
          if($inviteCodes[$key]->expiry_date == "0000-00-00" || $expiryTime > $today){
...
<li class="notice-invite-status">
  <div class="fields "><div class="cols-2">&nbsp;</div><!-- cols-3 -->
    <div class="cols-3 text-right"><i><?php echo _e('Please enable Invitation codes to send invitations','pie-register') ?>.</i></div><!-- cols-3 -->
  </div>
</li>
</ul>
</form>
