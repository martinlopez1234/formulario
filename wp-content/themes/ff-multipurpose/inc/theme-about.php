		...
		<div class="about-theme">
			<div class="theme-description">
				...
				<p class="actions">
					...
					<a href="<?php echo esc_url( 'https://fireflythemes.com/demo/ff-multipurpose' ); ?>" class="button button-secondary" target="_blank"><?php esc_html_e( 'Demo', 'ff-multipurpose' ); ?></a>
	...
	?>
		<div class="feature-section two-col">
			...
			<div class="col card">
				...
				<p><a href="<?php echo esc_url( 'https://fireflythemes.com/support-forum' ); ?>" class="button button-primary"><?php esc_html_e( 'Support Forum', 'ff-multipurpose' ); ?></a></p>
			</div>
		</div>
	<?php
	}
