 ...
 *
 * Class Profisme_Advanced_Import
 */
class Profisme_Advanced_Import {
	...
	public function replace_post_ids( $replace_post_ids ){
		...
		/*Post IDS*/
		$post_ids = array(
			'profisme-feature-post-one',
			'profisme-feature-post-two',
		);
 ...
 * @since    1.0.0
 */
function Profisme_advanced_import( ) {
	return Profisme_Advanced_Import::instance();
}
Profisme_advanced_import()->run();