...
jQuery( document ).ready(function($) {
    ...
    $(".collarbiz-chosen-select").chosen({
        width: "100%"
    });

    // icon picker
    $('.collarbiz-icon-picker').each( function() {
    ...
    $( document ).on( 'click', '.customize_multi_add_field', collarbiz_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', collarbiz_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', collarbiz_customize_multi_remove_field )
    ...
    function collarbiz_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            collarbiz_customize_multi_write( $control );
    }

    function collarbiz_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        collarbiz_customize_multi_write( $control );
    }

    function collarbiz_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function collarbiz_customize_multi_write( $element) {
