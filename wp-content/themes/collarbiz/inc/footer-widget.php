...
class CollarBiz_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'collarbiz';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'collarbiz' ), $i ),
...
// Initialize.
$collarbiz_footer_widgets = new CollarBiz_Footer_Widgets();
